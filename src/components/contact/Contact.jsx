      ...
      <div className="container contact__container">
        <div className="contact__options">
          ...
          <article className="contact__option">
             ...
             <h4>Email</h4>
             <h5>jitkumar263@gmail.com</h5>
             <a href="mailto:jitkumar263@gmail.com" target="_blank" className='btn btn-primary'>Send a message</a>
          </article>
          ...
          <article className="contact__option">
             ...
             <a href="https://www.linkedin.com/in/jitender-kumar-30a1111b6/" target="_blank" className='btn btn-primary'>Send a message</a>
          </article>
          ...
          <article className="contact__option">
             ...
             <h4>WhatsApp</h4>
             <h5>95099*****</h5>
             <a href="https://api.whatsapp.com/send?phone=+919509902769" target="_blank" className='btn btn-primary'>Send a message</a>
          </article>
